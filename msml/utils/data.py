...
import msml.utils.misc as utils
from msml.utils.dformats import DataFormat, DataFormatA
from msml.models.layers.feed_forward import FeedForward
from msml.models.optimization.losses_metrics import FingerprintMetrics, CosSimLoss
from msml.models.optimization.samplers import MaxVarBatchSampler
...
class MSData:
    ...
    def from_pandas(
        ...
        spec_col='PARSED PEAKS',  # The default values are set according to NIST20 format
        prec_mz_col='PRECURSOR M/Z',
